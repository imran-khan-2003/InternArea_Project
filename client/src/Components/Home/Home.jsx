                ...
                <>
                  <div className="int-1 mt-6" key={index}>
                    ...
                    <div className="more flex justify-between mt-6">
                      ...
                      <Link to={`/intern_detail?q=${data._id}`}><span className="text-blue-500 mr-2">
...
<div className="analytics mt-8 flex flex-wrap justify-center items-center text-center">
    <div className="text-block mt-5  ml-5 mr-5">
...
<div className="text-block mt-5 ml-5 mr-5">
    <span className='font-bold text-6xl text-blue-600'>21M+</span>
    <p>active students</p>
</div>
<div className="text-block mt-5  ml-5 mr-5">
